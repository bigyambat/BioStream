...
import { Play, Square, RotateCcw, RotateCw, Save, FolderOpen, Download, Upload, Trash2, MousePointer, X } from 'lucide-react'
...
export const Toolbar: React.FC = () => {
  ...
  return (
    <Card className="border-0 rounded-none border-b border-slate-200 bg-white/95 backdrop-blur-sm pointer-events-none">
